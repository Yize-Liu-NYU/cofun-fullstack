# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in cofun.
...
base_config.update_blueprint({
    'use_sqlalchemy': True,
    'model': cofun.model,
    'DBSession': cofun.model.DBSession,
})
...
base_config.update_blueprint({
    ...
    'sa_auth.cookie_secret': "265ed00a-cf6f-461c-b1a7-fd5f4857b479",
